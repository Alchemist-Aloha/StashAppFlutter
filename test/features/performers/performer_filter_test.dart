...
void main() {
  group('PerformerFilterNotifier', () {
    test('build handles List<String> in shared preferences correctly', () async {
    ...
    test('build handles legacy String in shared preferences correctly', () async {
      SharedPreferences.setMockInitialValues({
    ...
    test('build handles favoritesOnly in shared preferences correctly', () async {
      SharedPreferences.setMockInitialValues({
