...
mixin _$Image {
 ...
 String get id; String? get title;@JsonKey(name: 'rating100') int? get rating100; String? get date; List<String> get urls; ImagePaths get paths;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Image&&(identical(other.id, id) || other.id == id)&&(identical(other.title, title) || other.title == title)&&(identical(other.rating100, rating100) || other.rating100 == rating100)&&(identical(other.date, date) || other.date == date)&&const DeepCollectionEquality().equals(other.urls, urls)&&(identical(other.paths, paths) || other.paths == paths));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,title,rating100,date,const DeepCollectionEquality().hash(urls),paths);

@override
String toString() {
  return 'Image(id: $id, title: $title, rating100: $rating100, date: $date, urls: $urls, paths: $paths)';
}
...
@useResult
$Res call({
 String id, String? title,@JsonKey(name: 'rating100') int? rating100, String? date, List<String> urls, ImagePaths paths
});
...
/// Create a copy of Image
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? title = freezed,Object? rating100 = freezed,Object? date = freezed,Object? urls = null,Object? paths = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String? title, @JsonKey(name: 'rating100')  int? rating100,  String? date,  List<String> urls,  ImagePaths paths)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Image() when $default != null:
return $default(_that.id,_that.title,_that.rating100,_that.date,_that.urls,_that.paths);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String? title, @JsonKey(name: 'rating100')  int? rating100,  String? date,  List<String> urls,  ImagePaths paths)  $default,) {final _that = this;
switch (_that) {
case _Image():
return $default(_that.id,_that.title,_that.rating100,_that.date,_that.urls,_that.paths);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String? title, @JsonKey(name: 'rating100')  int? rating100,  String? date,  List<String> urls,  ImagePaths paths)?  $default,) {final _that = this;
switch (_that) {
case _Image() when $default != null:
return $default(_that.id,_that.title,_that.rating100,_that.date,_that.urls,_that.paths);case _:
  return null;
...
class _Image implements Image {
  const _Image({required this.id, this.title, @JsonKey(name: 'rating100') this.rating100, this.date, final  List<String> urls = const [], required this.paths}): _urls = urls;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Image&&(identical(other.id, id) || other.id == id)&&(identical(other.title, title) || other.title == title)&&(identical(other.rating100, rating100) || other.rating100 == rating100)&&(identical(other.date, date) || other.date == date)&&const DeepCollectionEquality().equals(other._urls, _urls)&&(identical(other.paths, paths) || other.paths == paths));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,title,rating100,date,const DeepCollectionEquality().hash(_urls),paths);
...
/// Create a copy of Image
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? title = freezed,Object? rating100 = freezed,Object? date = freezed,Object? urls = null,Object? paths = null,}) {
  return _then(_Image(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
as String,title: freezed == title ? _self.title : title // ignore: cast_nullable_to_non_nullable
as String?,rating100: freezed == rating100 ? _self.rating100 : rating100 // ignore: cast_nullable_to_non_nullable
