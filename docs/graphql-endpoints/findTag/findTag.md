# findTag — GraphQL endpoint

## Purpose
High-level purpose of `findTag` and when to use it from the client.
...
- `stash/ui/v2.5/src/components/Tags/TagPopover.tsx` (line ~24) — snippet: `if (!data?.findTag)`
- `stash/ui/v2.5/src/components/Tags/TagPopover.tsx` (line ~27) — snippet: `const tag = data.findTag;`
...
- `stash/ui/v2.5/src/components/Tags/TagDetails/Tag.tsx` (line ~596) — snippet: `if (!data?.findTag)`
- `stash/ui/v2.5/src/components/Tags/TagDetails/Tag.tsx` (line ~610) — snippet: `return <TagPage tag={data.findTag} tabKey={tab as TabKey | undefined} />;`
...
- `stash/ui/v2.5/src/core/createClient.ts` (line ~58) — snippet: `findTag: {`
- `stash/ui/v2.5/src/components/Tagger/queries.ts` (line ~128) — snippet: `findTags: {`
- `stash/ui/v2.5/src/components/Tagger/utils.ts` (line ~201) — snippet: `async (tagId) => (await queryFindTag(tagId))?.data?.findTag?.stash_ids,`
