# findScene — GraphQL endpoint

## Purpose
High-level purpose of `findScene` and when to use it from the client.
...
- `stash/ui/v2.5/src/components/Scenes/SceneMarkerList.tsx` (line ~107) — snippet: `const marker = queryResults.data.findSceneMarkers.scene_markers[index];`
- `stash/ui/v2.5/src/components/Scenes/SceneMarkerList.tsx` (line ~235) — snippet: `getCount: (r) => r.data?.findSceneMarkers.count ?? 0,`
- `stash/ui/v2.5/src/components/Scenes/SceneMarkerList.tsx` (line ~236) — snippet: `getItems: (r) => r.data?.findSceneMarkers.scene_markers ?? [],`
...
- `stash/ui/v2.5/src/components/Scenes/SceneMarkerRecommendationRow.tsx` (line ~18) — snippet: `const count = result.data?.findSceneMarkers.count ?? 0;`
- `stash/ui/v2.5/src/components/Scenes/SceneMarkerRecommendationRow.tsx` (line ~37) — snippet: `: result.data?.findSceneMarkers.scene_markers.map((marker, index) => (`
- `stash/ui/v2.5/src/components/Scenes/SceneDetails/Scene.tsx` (line ~767) — snippet: `setScene(data?.findScene ?? undefined);`
...
- `stash/ui/v2.5/src/components/Scenes/SceneDetails/SceneCreate.tsx` (line ~25) — snippet: `if (data?.findScene) {`
- `stash/ui/v2.5/src/components/Scenes/SceneDetails/SceneCreate.tsx` (line ~27) — snippet: `...data.findScene,`
- `stash/ui/v2.5/src/components/Scenes/SceneDetails/SceneCreate.tsx` (line ~36) — snippet: `}, [data?.findScene, query]);`
- `stash/ui/v2.5/src/components/Scenes/SceneDetails/SceneCreate.tsx` (line ~40) — snippet: `const srcScene = data?.findScene;`
- `stash/ui/v2.5/src/components/Scenes/SceneDetails/SceneCreate.tsx` (line ~54) — snippet: `}, [data?.findScene]);`
...
- `stash/ui/v2.5/src/core/createClient.ts` (line ~55) — snippet: `findScene: {`
